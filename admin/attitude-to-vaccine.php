    ...
    <div class="col-12" >
      <div class="card bg-gradient-x-info">
        <div class="card-content">
          <div class="row">   
            <?php include 'assets/graphs/vaccine_rollout.php'; ?>
          </div>
        </div>
      </div>
    </div>
  ...
  <p style="font-size: 18px">
    ...
    <div class="col-12" >
      <div class="card bg-gradient-x-info">
        <div class="card-content">
          <div class="row">   
            <?php include 'assets/graphs/vaccine_prioritise_vaccine.php'; ?>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row" >
    <div class="col-12" >
      <div class="card bg-gradient-x-info">
        <div class="card-content">
          <div class="row">   
            <?php include 'assets/graphs/vaccine_infoAndsafety.php'; ?>
          </div>
        </div>
      </div>
    </div>
  ...
  <p style="font-size: 18px">
    ...
    <div class="col-12" >
      <div class="card bg-gradient-x-info">
        <div class="card-content">
          <div class="row">   
            <?php include 'assets/graphs/vaccine_something5G.php'; ?>
          </div>
        </div>
      </div>
    </div>
